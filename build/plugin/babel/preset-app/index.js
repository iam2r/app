...
module.exports = (context, options = {}) => {
  ...
  const defaultIgnoreBrowserslistConfig = (isModern =
    process.env.BUILD_MODE == "modern");
  ...
  if (options.jsx !== false && options.appsTypes != false) {
    switch (true) {
      case appsTypes.react && appsTypes.react.includes(process.env.APP_NAME):
        presets.push("@babel/preset-react");
        break;
      case appsTypes.vue && appsTypes.vue.includes(process.env.APP_NAME):
        presets.push([
