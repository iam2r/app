...
module.exports = {
  titleMap: {
    [apps.test]: "Study",
    [apps.neteasecloud]: "NeteaseCloud",
  },
  ...
  appsTypes: {
    ...
    vue: [apps.blog, apps.home, apps.birthday, apps.test, apps.neteasecloud],
  },
  inlineLimit: 4096,
  dllVendorBlackList: [
    /^@/,
    /\.css$/,
    /antd|vant|element-ui|mint-ui|core-js|regenerator-runtime/,
  ],
