...
if (process.env.BUILD_MODE !== BUILDMODE.modern) {
  //modern时不需要清理
  plugins.push(
    new CleanWebpackPlugin({
      cleanOnceBeforeBuildPatterns: [
        config.staticPath + "/" + process.env.APP_NAME,
      ],
...
if (utils.isTiny()) {
  plugins.push(
    new TinypngPlugin({
      key: [
        "33QNhnkPG9L5N26DjH7wXLXShrQDhlw8",
        "qKBM0gLxycnZ0yJj0mGb4dTtPxgFbZN6",
        "9RNwdk4jcXsNvmGLSzCjQdvpHP1MntpQ",
        "JZ1kBDyGGMCSC7DZNkBC5D1s5GMrNMzy",
      ], //can be Array, eg:['your key 1','your key 2'....]
